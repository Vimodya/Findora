...
/// <summary>
/// Body for <c>PUT /api/v1/lost-items/{id}</c>. Deliberately excludes
...
/// <c>LostItemsController</c>/<c>LostItemService</c>).
/// </summary>
public class UpdateLostItemRequest : IValidatableObject
{
    [Required]
    [MaxLength(150)]
